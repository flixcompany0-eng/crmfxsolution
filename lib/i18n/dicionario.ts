...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Windsor.ai — aba de Conexões e painéis de Meta Ads / Instagram (0233) ───
  "Windsor.ai": { es: "Windsor.ai" },
  "Windsor.ai — Meta Ads e Instagram": { es: "Windsor.ai — Meta Ads e Instagram" },
  "Uma conexão isolada, à parte do canal do WhatsApp e do token direto da Meta: cole aqui a chave de API da sua conta Windsor.ai para trazer as métricas de Meta Ads e Instagram para dentro do CRM.": {
    es: "Una conexión aislada, aparte del canal de WhatsApp y del token directo de Meta: pega aquí la clave de API de tu cuenta Windsor.ai para traer las métricas de Meta Ads e Instagram al CRM.",
  },
  "Entre em ": { es: "Entra en " },
  " e conecte suas contas de Meta Ads e Instagram por lá (OAuth deles, não desta tela).": {
    es: " y conecta tus cuentas de Meta Ads e Instagram allí (OAuth de ellos, no de esta pantalla).",
  },
  "Copie a chave de API do seu painel Windsor.ai.": { es: "Copia la clave de API de tu panel Windsor.ai." },
  "Cole a chave abaixo e clique em Conectar.": { es: "Pega la clave abajo y haz clic en Conectar." },
  "Chave de API do Windsor.ai": { es: "Clave de API de Windsor.ai" },
  "Conectar Windsor.ai": { es: "Conectar Windsor.ai" },
  "Windsor.ai conectado.": { es: "Windsor.ai conectado." },
  "Windsor.ai desconectado.": { es: "Windsor.ai desconectado." },
  "Windsor.ai conectado": { es: "Windsor.ai conectado" },
  "A chave está guardada criptografada e nunca é mostrada de volta.": {
    es: "La clave está guardada cifrada y nunca se muestra de nuevo.",
  },
  "Contas de Meta Ads": { es: "Cuentas de Meta Ads" },
  "Perfis de Instagram": { es: "Perfiles de Instagram" },
  "Abrir painel": { es: "Abrir panel" },
  "Nenhuma conta adicionada ainda.": { es: "Ninguna cuenta agregada todavía." },
  "padrão": { es: "predeterminada" },
  "Conta removida.": { es: "Cuenta eliminada." },
  "Adicionar outra conta da mesma empresa": { es: "Agregar otra cuenta de la misma empresa" },
  "Escolha uma conta alcançada pela chave": { es: "Elige una cuenta alcanzada por la clave" },
  "Nenhuma conta nova encontrada.": { es: "No se encontró ninguna cuenta nueva." },
  "Conta adicionada.": { es: "Cuenta agregada." },
  "Atualizado.": { es: "Actualizado." },
  "Meta Ads (Windsor.ai)": { es: "Meta Ads (Windsor.ai)" },
  "Instagram (Windsor.ai)": { es: "Instagram (Windsor.ai)" },
  "Métricas de conta, criativos e saldo, agregados pelo Windsor.ai — uma fonte isolada, independente da conexão direta com a Meta.": {
    es: "Métricas de cuenta, creativos y saldo, agregados por Windsor.ai — una fuente aislada, independiente de la conexión directa con Meta.",
  },
  "Seguidores, alcance e o conteúdo recente do perfil, agregados pelo Windsor.ai.": {
    es: "Seguidores, alcance y el contenido reciente del perfil, agregados por Windsor.ai.",
  },
  "Windsor.ai ainda não foi conectado.": { es: "Windsor.ai todavía no fue conectado." },
  "Conecte a chave de API do Windsor.ai em Conexões para ver os dados aqui.": {
    es: "Conecta la clave de API de Windsor.ai en Conexiones para ver los datos aquí.",
  },
  "Peça a quem administra a organização para conectar o Windsor.ai em Conexões.": {
    es: "Pide a quien administra la organización que conecte Windsor.ai en Conexiones.",
  },
  "Nenhuma conta de Meta Ads adicionada.": { es: "Ninguna cuenta de Meta Ads agregada." },
  "Nenhum perfil de Instagram adicionado.": { es: "Ningún perfil de Instagram agregado." },
  "Adicione uma conta em Conexões › Windsor.ai para ver os dados aqui.": {
    es: "Agrega una cuenta en Conexiones › Windsor.ai para ver los datos aquí.",
  },
  "Adicione um perfil em Conexões › Windsor.ai para ver os dados aqui.": {
    es: "Agrega un perfil en Conexiones › Windsor.ai para ver los datos aquí.",
  },
  "Cliques": { es: "Clics" },
  "Investimento": { es: "Inversión" },
  "Criativos": { es: "Creativos" },
  "Conteúdo recente": { es: "Contenido reciente" },
  "Nenhum criativo no período. Clique em Atualizar.": {
    es: "Ningún creativo en el período. Haz clic en Actualizar.",
  },
  "Nenhum post no período. Clique em Atualizar.": {
    es: "Ninguna publicación en el período. Haz clic en Actualizar.",
  },
  "Sem prévia": { es: "Sin vista previa" },
  "Sem legenda": { es: "Sin descripción" },
  "impr.": { es: "impr." },
  "sincronizado em": { es: "sincronizado el" },
  "Seguidores": { es: "Seguidores" },
  "Alcance no período": { es: "Alcance en el período" },
  "Impressões no período": { es: "Impresiones en el período" },
  "Visualizações de perfil": { es: "Visualizaciones de perfil" },
  "Saldo e depósitos": { es: "Saldo y depósitos" },
  "Conectar saldo (opcional)": { es: "Conectar saldo (opcional)" },
  "Não disponível pelo Windsor.ai — exige um token de sistema da Meta Business, separado da chave do Windsor.ai. Histórico de depósito não é suportado nesta versão; saldo e gasto total, sim.": {
    es: "No disponible por Windsor.ai — requiere un token de sistema de Meta Business, separado de la clave de Windsor.ai. El historial de depósitos no es compatible en esta versión; el saldo y el gasto total, sí.",
  },
  "Token de sistema Meta Business": { es: "Token de sistema de Meta Business" },
  "Salvar e sincronizar": { es: "Guardar y sincronizar" },
  "Não consegui salvar o token.": { es: "No pude guardar el token." },
  "Saldo sincronizado.": { es: "Saldo sincronizado." },
  "Token salvo, mas não consegui ler o saldo agora.": {
    es: "Token guardado, pero no pude leer el saldo ahora.",
  },
};
