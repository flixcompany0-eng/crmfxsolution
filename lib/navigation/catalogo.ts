...
export const NAV_CATALOG = [
  ...
  {
    // Irmã de "Meta Ads" acima, e deliberadamente ao lado dela: mesma
    // pergunta ("quanto custou trazer gente"), fonte diferente e ISOLADA —
    // Windsor.ai, não o token direto da Meta. Ver o cabeçalho da migration
    // 0233 para o porquê de as duas conexões não se tocarem.
    href: "/app/ads/windsor/meta",
    label: "Meta Ads (Windsor.ai)",
    description: "Métricas de conta, criativos e saldo agregados pelo Windsor.ai.",
    icon: "Megaphone",
    group: "analise",
    section: "Os números do período",
    minRole: "manager",
  ...
  {
    // Não existe eixo direto de Instagram nesta casa — Windsor.ai é a
    // primeira e única fonte desses dados até aqui.
    href: "/app/ads/windsor/instagram",
    label: "Instagram (Windsor.ai)",
    description: "Seguidores, alcance e conteúdo recente do perfil.",
    icon: "InstagramLogo",
    group: "analise",
    section: "Os números do período",
    minRole: "manager",
