...
export const ApiErrorCodes = {
  ...
  // Eixo Windsor.ai (migration 0233) — irmão do bloco acima, credencial e
  // tabela próprias (ver o cabeçalho da migration). `windsor_conta_nao_encontrada`
  // é 404 (o recurso é NOSSO, `windsor_ad_accounts.id`), as outras duas são 422
  // pela mesma razão do bloco `ads_*`: a credencial que falhou é de terceiro,
  // não a sessão de quem está com a tela aberta.
  windsor_sem_conexao: "windsor_sem_conexao",
  windsor_cifra_indisponivel: "windsor_cifra_indisponivel",
  windsor_conta_nao_encontrada: "windsor_conta_nao_encontrada",
