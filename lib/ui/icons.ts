...
export {
  ...
  Megaphone,
  // Instagram (Windsor.ai) — único lugar do menu que fala de Instagram; a
  // logo da rede é reconhecível de relance, ao contrário de um ChartX
  // genérico, e não colide com nenhuma outra entrada do grupo "Análise".
  InstagramLogo,
  // health dashboard
  WifiHigh,
  Brain,
